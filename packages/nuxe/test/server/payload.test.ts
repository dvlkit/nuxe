...
function parseSerialized<T = Record<string, unknown>>(result: string): T {
...
describe('serializePayload', () => {
    it('serializes plain objects', () => {
        ...
        expect(parseSerialized(result)).toEqual(payload)
    })
    ...
    it('serializes rich types supported by devalue', () => {
        ...
        const result = serializePayload(payload)
        const parsed = parseSerialized<typeof payload>(result)
    ...
    it('sanitizes dangerous keys inside Maps', () => {
        ...
        const parsed = parseSerialized<{ map: Map<string, number> }>(result)
    ...
    it('handles circular references without crashing', () => {
        ...
        const parsed = parseSerialized<{ circular: Record<string, unknown> }>(result)
